...
const StockItem = () => {
  return (
    <View className='flex flex-row justify-between items-center px-4 py-2 rounded-md bg-white shadow-md hover:border-2 hover:border-green-500'>
     <View>
         <Text className='font-bold text-3xl uppercase'>DOW J</Text>
         <Text className='text-xs font-bold text-gray-600'>Down Jones Industrial</Text>
     </View>
